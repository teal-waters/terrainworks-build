...
modules/utils.o : modules/utils.f90 modules/Utilities.o modules/data_modules.o 
modules/kernel_module.o : modules/kernel_module.f90 modules/utils.o modules/DEM_module.o modules/Utilities.o modules/data_modules.o 
modules/derivs_module.o : modules/derivs_module.f90 modules/Utilities.o modules/error_handler.o modules/data_modules.o 
modules/surface_fit.o : modules/surface_fit.f90 modules/derivs_module.o modules/kernel_module.o modules/DataTableModule.o modules/DEM_module.o modules/Grid_Module.o modules/utils.o modules/Utilities.o modules/error_handler.o modules/data_modules.o 
...
GridUtilities/build_derivs.o : GridUtilities/build_derivs.f90 modules/kernel_module.o modules/surface_fit.o modules/utils.o modules/derivs_module.o modules/Utilities.o modules/DataTableModule.o modules/DEM_module.o modules/Grid_Module.o modules/Utilities.o modules/error_handler.o modules/data_modules.o 
